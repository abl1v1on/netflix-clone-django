    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profiles', models.ManyToManyField(blank=True, related_name='user_profiles', to='netflixapp.profile')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age_limit', models.CharField(choices=[('All', 'All'), ('Kids', 'Kids')], max_length=10)),
                ('video', models.ManyToManyField(related_name='movie_content', to='netflixapp.video')),
            ],
        ),
    ]
